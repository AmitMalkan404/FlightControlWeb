...
namespace FlightControllWeb.Controllers
{
    ...
    public class FlightsControllerTests
    {
        ...
        public async Task PostFlightPlanTest()
        {
            ...
            var contextFlight = contextFlights.Where(a => a.FlightId.CompareTo("EL-0123") == 0).First();


            //Assert

            Assert.IsNotNull(contextFlight);
            Assert.IsTrue(contextFlight.FlightId.CompareTo("EL-0123") ==0);
